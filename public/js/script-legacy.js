                ...
                <table class="approval-table">
                    ...
                    <tbody>
                        ${pendingStaff.map(staff => {
                            const idFront = staff.idFront || '/images/picture.jpg';
                            const idBack = staff.idBack || '/images/picture.jpg';
                            const faceDoc = staff.faceDoc || '/images/picture.jpg';
                            return `
                            <tr>
                                ...
                                <td><img class="approval-doc-thumb" src="${esc(idFront)}" onerror="this.src='/images/picture.jpg'" onclick="openImageZoom('${esc(idFront)}')"></td>
                                <td><img class="approval-doc-thumb" src="${esc(idBack)}" onerror="this.src='/images/picture.jpg'" onclick="openImageZoom('${esc(idBack)}')"></td>
                                <td><img class="approval-doc-thumb" src="${esc(faceDoc)}" onerror="this.src='/images/picture.jpg'" onclick="openImageZoom('${esc(faceDoc)}')"></td>
                                <td>
        ...
        function validateSuStep6() {
            ...
            document.getElementById('suSummaryAvatar').src = suData.faceDoc || '/images/picture.jpg';
...
function handleWizardAvatarUpload(event) {
        ...
        function openStaffProfile() {
            ...
            container.innerHTML = `
                ...
                <div class="profile-avatar-large" onclick="document.getElementById('profileImageFile').click()" title="Click to change photo">
                    <img id="profileAvatarImg" src="${esc(staffData.avatar || '/images/picture.jpg')}" alt="Profile" onerror="this.onerror=null;this.src='/images/picture.jpg'">
                </div>
    ...
    <div class="modal-overlay" id="exportPasswordModal">
        ...
        function openDonorProfile(donor) {
            ...
            container.innerHTML = `
                ...
                <div class="profile-avatar-large" onclick="document.getElementById('profileImageFile').click()" title="Click to change photo">
                    <img id="profileAvatarImg" src="${esc(donor.avatar || '/images/picture.jpg')}" alt="Profile" onerror="this.onerror=null;this.src='/images/picture.jpg'">
                </div>
                <div class="profile-photo-change-text" onclick="document.getElementById('profileImageFile').click()">
                    <i class="fa-solid fa-camera"></i> Click to change photo
                </div>
                ...
                card.innerHTML = `
                    ...
                    <div class="donor-avatar-area">
                        <div class="avatar-circle">
                            <img src="${esc(donor.avatar || '/images/picture.jpg')}" alt="Donor" onerror="this.src='/images/picture.jpg'">
                        </div>
                    </div>
    ...
    function toggleRecordSelect(id, checked) {
        ...
        function commitNewDonor() {
            ...
            const avatarSrc = document.getElementById('wizardAvatarPreview').src || '/images/picture.jpg';
        ...
        function resetDonorWizardForm() {
            ...
            if (avatarPreview) avatarPreview.src = '/images/picture.jpg';
        }
