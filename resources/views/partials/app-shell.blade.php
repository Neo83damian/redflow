        ...
        <div id="main-content" class="main-content">
            ...
            <header class="top-bar">
                ...
                <div class="top-profile-avatar" onclick="openStaffProfile()">
                    <img id="headerAvatarImg" src="{{ asset('images/picture.jpg') }}" alt="Profile" onerror="this.onerror=null;this.src='picture.jpg'">
                </div>
            </header>
            <!-- HOME PAGE VIEW -->
                ...
                <div id="wizard-step-4" class="wizard-step-container">
                    <div class="wizard-inner-box" style="text-align:left;">
                        ...
                        <div class="profile-upload-circle" onclick="document.getElementById('wizardAvatarFile').click()">
                            <img id="wizardAvatarPreview" src="{{ asset('images/picture.jpg') }}" alt="Avatar" onerror="this.onerror=null;this.src='picture.jpg'">
                        </div>
